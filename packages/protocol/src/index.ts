...
export const SwapQuoteSchema = z.object({
  ...
  preimageHash: z
    .string()
    .length(64)
    .transform((s) => s as PreimageHex),
  makerPubkey: z
    .string()
    .length(64)
    .transform((s) => s as PubkeyHex),
});
...
export async function getTxHash(
  inputs: Omit<ArkInput, 'signature'>[],
  outputs: ArkOutput[],
): Promise<string> {
