          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Initiate a deposit that will be processed in the next Round (5
                seconds)
              </p>
              {liftStatus && (
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    disabled={
                      isRequestingQuote || !swapAmount || hasInsufficientFunds
                    }
                    className={cn(
                            ...
                            <button
                              onClick={() => {
                                ...
                                if (!isNaN(amount) && amount > 0 && address) {
                                  try {
                                    const selected = mockArkClient.selectCoins(
                                      address,
                                      amount,
                                    );
                                    setSelectedVtxos(
                            ...
                            <p className="text-xs text-gray-400">
                              ...
                              {requiredAmount > 0 && (
                                ...
                                >
                                  ...
                                  {requiredAmount.toLocaleString()} required)
                                </span>
                              )}
                            </p>
                          </div>
